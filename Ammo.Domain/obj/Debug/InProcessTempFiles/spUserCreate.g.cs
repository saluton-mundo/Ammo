...
namespace Ammo.Domain.Repositories {
    ...
    public partial class spUserCreate : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(spUserCreate).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(spUserCreate));
        ...
        private string FindResource() {
            string[] resources = typeof(spUserCreate).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".spUserCreate.g.xaml") || resource.Equals("spUserCreate.g.xaml"))) {
                    return resource;
                }
            }
